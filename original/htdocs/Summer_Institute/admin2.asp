...
<form BOTID="0" METHOD="POST" ACTION="Admin.asp">
  <table BORDER="0">
    <tr>
      <td><b>Name</b></td>
    ...
    <tr>
      <td><b>State</b></td>
      <td><input TYPE="TEXT" NAME="State" VALUE="<%=Request("State")%>" size="20"></td>
    </tr>
    <tr>
      <td><b>School</b></td>
      <td><input TYPE="TEXT" NAME="School" VALUE="<%=Request("School")%>" size="20"></td>
    </tr>
  </table>
  <br>
...
s-dataconnection="ApplicationData" b-tableformat="FALSE" b-menuformat="FALSE"
...
s-criteria s-order
s-sql="SELECT * FROM TeachersApplication2000 WHERE (Name LIKE '%::Name::%' OR State LIKE '%::State::%' OR School LIKE '%::School::%')"
b-procedure="FALSE" clientside SuggestedExt="asp"
s-DefaultFields="Name=&amp;State=&amp;School="
...
<%
fp_sQry="SELECT * FROM TeachersApplication2000 WHERE (Name LIKE '%::Name::%' OR State LIKE '%::State::%' OR School LIKE '%::School::%')"
fp_sDefault="Name=&State=&School="
fp_sNoRecords="No records returned."
fp_sDataConn="ApplicationData"
fp_iMaxRecords=5
fp_iCommandType=1
fp_iPageSize=0
...
Award Date)&nbsp;</P>
  ...
  <tr>
    ...
    <td width="71%" height="19"><!--webbot bot="DatabaseResultColumn" startspan
      s-columnnames="ID,Name,SocialSecurity,Address,Phone,eMail,School,SchoolPhone,PrincipalName,CollegesAttended,UndergradCourses,GradCourses,YearsExp,TeachingAssign,FutureTeachings,ProDev,LeadershipActivities,Publications,TeachingPhilosophy,EquiptExperience,CompExpierence,IntExpierence,HowDidYouLearnAboutUs,Complete,City,State,Zip"

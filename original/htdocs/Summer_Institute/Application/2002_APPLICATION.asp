...
If Request.Form("VTI-GROUP") = "0" Then
	...
	fp_rs.Open "TeachersApplication2002", fp_conn, 1, 3, 2 ' adOpenKeySet, adLockOptimistic, adCmdTable
...
<P ALIGN=CENTER><img alt="Princeton Plasma Physics Laboratory" src="../application/title_centered.gif" width="450" height="50"></P>
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="2002_APPLICATION.asp" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1" webbot-action="--WEBBOT-SELF--" language="JavaScript">
  <!--webbot bot="SaveDatabase" startspan SuggestedExt="asp"
  U-ASP-Include-Url="../_fpclass/fpdbform.inc" S-DataConnection="PlasmaCamp"
  S-RecordSource="TeachersApplication2002"
  U-Database-URL="../../fpdb/ApplicationData.mdb"
  U-Confirmation-Url="eMailRecNotice.asp"
  S-Builtin-Fields="REMOTE_HOST HTTP_USER_AGENT Timestamp"
  S-Builtin-DBFields="Remote_computer_name1 Browser_type1 Timestamp"
  S-Form-Fields="CollegesAttended School EquiptExperience CompExpierence HowLearn GradCourses TeachingAssign TeachingPhilosophy Complete SchoolPhone UndergradCourses email phone PrincipalName ProDev IntExpierence City FutureTeachings Zip LeadershipActivities name YearsExp Publications Address State"
  S-Form-DBFields="CollegesAttended School2 EquiptExperience CompExpierence HowDidYouLearnAboutUs GradCourses TeachingAssign TeachingPhilosophy Complete School2Phone UndergradCourses eMail Phone PrincipalName ProDev IntExpierence City FutureTeachings Zip LeadershipActivities Name YearsExp Publications Address State" --><input TYPE="hidden" NAME="VTI-GROUP" VALUE="0"><!--#include file="../_fpclass/fpdbform.inc"--><!--webbot
...
BEGINNING!</span></b></P>
          ...
          <P ALIGN=CENTER>It is <B>strongly suggested</B> that you answer the longer
...
submitting it.</P>
      ...
      <tr>
        ...
        <td width="71%" height="19">
          ...
          I-Maximum-Length="100" --><INPUT NAME="name" TYPE="text" SIZE="29" tabindex="1" maxlength="100"></P>
      ...
      <tr>
        ...
        Address</b></td>
        <td width="71%" height="10"><INPUT NAME="Address" TYPE="text" SIZE="29" tabindex="3"></td>
      </tr>
      <tr>
        <td width="29%" bgcolor="#EBEBEB" valign="top" height="13" align="right"><b>City</b></td>
        <td width="71%" height="13"><INPUT NAME="City" TYPE="text" SIZE="29" tabindex="4"></td>
      </tr>
    </center>
    <tr>
      ...
      <center>
                <td width="65%" height="21"><input type="text" name="State" size="20"></td>
              </tr>    <tr>
        <td width="29%" bgcolor="#EBEBEB" valign="top" height="14" align="right"><b>Zip</b></td>
        <td width="71%" height="14"><INPUT NAME="Zip" TYPE="text" SIZE="7" tabindex="6"></td>
      </tr>
      <tr>
        <td width="29%" bgcolor="#EBEBEB" valign="top" height="19" align="right"><b>Phone</b></td>
        <td width="71%" height="19"><font size="1"><!--webbot bot="Validation"
          B-Value-Required="TRUE" I-Minimum-Length="12" --><INPUT NAME="phone" TYPE="text" SIZE="29" tabindex="7">(i.e.
      ...
      <tr>
        ...
        <td width="71%" height="19"><!--webbot bot="Validation"
          B-Value-Required="TRUE" I-Maximum-Length="25" --><INPUT NAME="email" TYPE="text" SIZE="29" tabindex="8" maxlength="25"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="71%" height="19">
          ...
          <P><textarea rows="2" name="School" cols="56"></textarea></P>
      ...
      <tr>
        <td width="29%" bgcolor="#EBEBEB" valign="top" height="19" align="right"><b>School
        Phone #&nbsp;</b></td>
        <td width="71%" height="19"> <INPUT NAME="SchoolPhone" TYPE="text" SIZE="29"></td>
      </tr>
      <tr>
        <td width="29%" bgcolor="#EBEBEB" valign="top" height="19" align="right"><b>Principal's
        Name</b></td>
        <td width="71%" height="19"><INPUT NAME="PrincipalName" TYPE="text" SIZE="29"></td>
      </tr>
      <tr>
...
Award Date)&nbsp;</P>
        ...
        <td width="71%" height="19"><TEXTAREA NAME="CollegesAttended" ROWS="6" COLS="55"
></TEXTAREA></td>
      </tr>
    </center>
    <tr>
      ...
      <tr>
        ...
        <td width="71%" height="19"><TEXTAREA NAME="UndergradCourses" ROWS="4" COLS="55"
></TEXTAREA></td>
      </tr>
      <tr>
        <td width="29%" bgcolor="#EBEBEB" valign="top" height="19" align="right"><b>List graduate science/math/technology courses taken.</b></td>
        <td width="71%" height="19"><TEXTAREA NAME="GradCourses" ROWS="4" COLS="55"
></TEXTAREA></td>
      </tr>
      </center>
      <tr>
...
the sum of part-time teaching assignments.)</td>
          <td width="71%" height="19"><INPUT NAME="YearsExp"
TYPE="text" SIZE="29"></td>
        </tr>
        <tr>
          ...
          <td width="71%" height="19"><TEXTAREA NAME="TeachingAssign" ROWS="4" COLS="56"
></TEXTAREA></td>
        </tr>
        <tr>
 ...
 (if different from above):</td>
          <td width="71%" height="19"><TEXTAREA NAME="FutureTeachings" ROWS="4" COLS="56"
></TEXTAREA></td>
        </tr>
        <tr>
...
institutes, conferences, research experience) during the last 3 to 5 years</td>
          <td width="71%" height="19"><TEXTAREA NAME="ProDev" ROWS="4" COLS="56"
></TEXTAREA></td>
        </tr>
        </center>
        <tr>
...
accomplishments during the last 3 to 5 years.</b></td>
            <center>
            <td width="71%" height="19"><TEXTAREA NAME="LeadershipActivities" ROWS="4" COLS="56"
></TEXTAREA></td>
            </tr>
          </center>
          <tr>
            <td width="29%" bgcolor="#EBEBEB" valign="top" height="19">
              ...
              <center>
              <td width="71%" height="19"><TEXTAREA NAME="Publications" ROWS="4" COLS="56"
></TEXTAREA></td>
              </tr>
            </center>
            <tr>
...
if available. If necessary, this can be faxed instead of included here</b> (609-243-2112).</td>
                <center>
                <td width="71%" height="19"><TEXTAREA NAME="TeachingPhilosophy" ROWS="4" COLS="56"
></TEXTAREA></td>
                </tr>
                <tr>
...
Other electrical equipment? Vacuum pumps? Optics/Spectrometers? Lasers?</b></td>
                  <td width="71%" height="19"><TEXTAREA NAME="EquiptExperience" ROWS="4" COLS="56"
></TEXTAREA></td>
                </tr>
                <tr>
...
and length of experience</b></td>
                  <td width="71%" height="19"><TEXTAREA NAME="CompExpierence" ROWS="4" COLS="56"
></TEXTAREA></td>
                </tr>
                <tr>
                  <td width="29%" bgcolor="#EBEBEB" valign="top" height="19" align="right">
...
regularly?</b></P>
                    ...
                    <p>&nbsp;</td>
                    <td width="71%" height="19"><TEXTAREA NAME="IntExpierence" ROWS="4" COLS="56"
></TEXTAREA></td>
                  </tr>
                  <tr>
                    ...
                    <td width="71%" height="19">
                      ...
                      <P><textarea rows="2" name="HowLearn" cols="56"></textarea></P>

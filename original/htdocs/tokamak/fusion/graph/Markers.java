 ...
 *
 * @version $Revision: 1.2 $, $Date: 2004/10/07 20:05:25 $.
 * @author  Leigh Brookshaw, Daren Stotler
 */

/*
 * $Log: Markers.java,v $
 * Revision 1.2  2004/10/07 20:05:25  dstotler
 ...
 * 
 * 1.8 11-22-98 Updated to Java 1.1, including replacement of StreamTokenizer
 *              constructor in LoadMarkers.
 * 1.7 07-02-96 Brookshaw's original version.
*/
 ...
 * The first vertex should always be a setLocation (The boolean array is "true" 
 * for a relative draw.
 *
...
/*
   As of Java 1.1, this is the preferred method of converting an input
   stream. Not completely sure this is the right thing to do.

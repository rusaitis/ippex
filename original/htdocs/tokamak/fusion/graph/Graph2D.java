 ...
 *
 * @version  $Revision: 1.3 $, $Date: 2004/10/07 20:02:52 $.
 * @author   Leigh Brookshaw, Daren Stotler
 */

/*
 * $Log: Graph2D.java,v $
 * Revision 1.3  2004/10/07 20:02:52  dstotler
 * Move LoadMessage to a separate file.  Changes to javadoc comments.
 *
 * Revision 1.2  1999/11/19 21:36:15  dstotler
 * Changed a comment to make javadoc happy.
 *
 ...
 * 
 * 1.3 07-29-99 Replaced with Brookshaw's version 1.12.
 * 1.2 11-22-98 Replaced keyDown method with Java 1.1 keyPressed. Updated
 *              String constructor in loadFile.
 * 1.11 09-05-96 Brookshaw's version.
 */

public class Graph2D extends Canvas implements KeyListener {
                 ...
                 while( (c=is.read()) > -1 ) {
                     ...
                     switch (c) {
                         ...
                         case ' ': case '\t':
                                if( nbytes > 0 ) {
/*
  With java 1.1, this method is deprecated. The relacement below has the
  most similar signature. The platform's default character encoding is
  used. Not certain that this is the right thing to do!!

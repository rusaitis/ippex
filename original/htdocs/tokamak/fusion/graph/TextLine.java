 ...
 *
 * @version $Revision: 1.2 $, $Date: 2004/10/07 20:18:33 $.
 * @author  Leigh Brookshaw, Daren Stotler
 */

/*
 * $Log: TextLine.java,v $
 * Revision 1.2  2004/10/07 20:18:33  dstotler
 ...
 * 
 * 1.11 11-22-98 Split class TextState into separate file.
 * 1.10 09-05-96 Brookshaw's original version.
 */
...
*********************/
  ...
  /**
   * Labels whether or not the string has been parsed. This only needs to 
   * be done once unless the font is altered.
   */

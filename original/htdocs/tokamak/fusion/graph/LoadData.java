 ...
 * given a URL.
 *
 * @version  $Revision: 1.2 $, $Date: 2004/10/07 20:03:50 $.
 * @author   Leigh Brookshaw, Daren Stotler
 */

/*
 * $Log: LoadData.java,v $
 * Revision 1.2  2004/10/07 20:03:50  dstotler
 * Add some lines used in testing LoadMessage.
 *
 ...
 *
 * 1.10 08-11-99 Updated String constructor for Java 1.1.
 * 1.09 10-23-96 Brookshaw's original version.
 */
   ...
   */
    public DataSet loadDataSet( URL file, Object drawable ) {    
           ...
           if(drawable != null) {
              ...
              if(drawable instanceof Graph2D) {
                                ...
                                if( size >= datamax ) {
                                       ...
                                       System.out.println(
                                         "Loading Data! Points Loaded "+
                                          count);
				       /*
Enable next two lines to see the message printed by LoadMessage in the
example3 case.
				       */
				       //      long sleeptime = 500;
				       //  sleep(sleeptime);
